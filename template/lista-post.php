                    ...
                    <div class="row">
                        <div class="col" name="likeandcomm">
                            <?php if(isset($_SESSION["location"]) && $_SESSION["location"] == "profilo"){
                                ...
                                echo '<span class="commento-value">'.$post["numCommenti"].' <i class="commento-icon-value bi bi-chat" id="commenta-'.$post["idPost"].'"></i></span>';
                            }else if(isset($_SESSION["location"]) && $_SESSION["location"] == "like"){
                                echo '<i class="liked-icon bi bi-heart-fill" id="like-'.$post["idPost"].'"></i>';
                                echo '<i class="commento-icon bi bi-chat" id="commenta-'.$post["idPost"].'"></i>';
                            }else{
                                if($post["messoLike"]){
                                    echo '<i class="liked-icon bi bi-heart-fill" id="like-'.$post["idPost"].'"></i>';
                                }else{
